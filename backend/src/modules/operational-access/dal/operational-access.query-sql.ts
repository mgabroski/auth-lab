 ...
 *
 * WHY:
 * - Raw Kysely queries for the Operational Access Step 3 configuration foundation.
 * - Keeps tenant scoping and fail-closed reads at the query boundary.
 *
 * RULES:
 * - No AppError.
 * - No business decisions beyond tenant-scoped filtering.
 * - No Effective Access Resolver queries live here.
 */
